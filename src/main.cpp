...
// Firmware version - v5.4: Remote device configuration (RSSI/dwell thresholds from backend)
static const char* FIRMWARE_VERSION = "5.4";
...
static bool fetchAndApplyConfig() {
    ...
    if (!atSendCommandPrompt(cmd, ">", 5000)) {
